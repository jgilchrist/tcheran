...
impl Game {
    ...
    pub fn fill_moves(&self, movelist: &mut MoveList) {
        generate_moves::<true>(self, movelist);
    }

    pub fn fill_loud_moves(&self, movelist: &mut MoveList) {
        generate_moves::<false>(self, movelist);
    }
