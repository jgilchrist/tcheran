...
#[ignore]
fn perft_gist_10() {
    test_perft("3k4/3p4/8/K1P4r/8/8/8/8 b - - 0 1", 6, 1134888);
}

#[test]
#[ignore]
fn perft_gist_11() {
    test_perft("8/8/4k3/8/2p5/8/B2P2K1/8 w - - 0 1", 6, 1015133);
}

#[test]
#[ignore]
fn perft_gist_12() {
    test_perft("8/8/1k6/2b5/2pP4/8/5K2/8 b - d3 0 1", 6, 1440467);
}

#[test]
#[ignore]
fn perft_gist_13() {
    test_perft("5k2/8/8/8/8/8/8/4K2R w K - 0 1", 6, 661072);
}

#[test]
#[ignore]
fn perft_gist_14() {
    test_perft("3k4/8/8/8/8/8/8/R3K3 w Q - 0 1", 6, 803711);
}

#[test]
#[ignore]
fn perft_gist_15() {
    test_perft("r3k2r/1b4bq/8/8/8/8/7B/R3K2R w KQkq - 0 1", 4, 1274206);
}

#[test]
#[ignore]
fn perft_gist_16() {
    test_perft("r3k2r/8/3Q4/8/8/5q2/8/R3K2R b KQkq - 0 1", 4, 1720476);
}

#[test]
#[ignore]
fn perft_gist_17() {
    test_perft("2K2r2/4P3/8/8/8/8/8/3k4 w - - 0 1", 6, 3821001);
}

#[test]
#[ignore]
fn perft_gist_18() {
    test_perft("8/8/1P2K3/8/2n5/1q6/8/5k2 b - - 0 1", 5, 1004658);
}

#[test]
#[ignore]
fn perft_gist_19() {
    test_perft("4k3/1P6/8/8/8/8/K7/8 w - - 0 1", 6, 217342);
}
...
#[ignore]
fn perft_gist_22() {
    test_perft("8/k1P5/8/1K6/8/8/8/8 w - - 0 1", 7, 567584);
}
